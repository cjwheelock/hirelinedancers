...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes = ["", "/about/", "/instructors/", "/instructors/join/", "/blog/", "/guides/", "/guides/cost-to-hire-line-dance-instructor/", "/guides/start-a-line-dance-club-on-campus/", "/legal/terms/", "/legal/privacy/", "/legal/refund-policy/"];
  return [
