...
export default function RefundPolicyPage() {
  return (
    <section className="page-shell article-page">
      ...
      <p>The founding guarantee applies to the first 100 approved instructors who activate and maintain an active $14.99 monthly membership. If Hire Line Dancers does not help an eligible instructor get booked for a paid event within the first 12 months after membership activation, the instructor may request a refund of the membership payments made during that first year.</p>
      ...
      <p>Refunds are limited to membership payments actually collected during the first 12 months after activation and do not cover discounts, zero-dollar invoices, external costs, travel, or lost revenue. A verified guarantee refund closes the founding guarantee and its related founding benefits. It does not automatically cancel the paid membership. Instructors who want to stop future charges must cancel through the account billing portal or contact support for help.</p>
    </section>
  );
}
