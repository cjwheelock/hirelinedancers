...
export default function RefundPolicyPage() {
  return (
    <section className="page-shell article-page">
      ...
      <p>The founding guarantee applies to founding annual memberships (the first 100 approved instructors). If Hire Line Dancers does not help an eligible instructor get booked for a paid event within the first 12 months of membership, the first-year membership fee may be refunded in full.</p>
      ...
      <p>Refunds are limited to the first-year founding membership fee and do not cover external costs, travel, lost revenue, or payment processing fees unless legally required. A refunded membership ends the membership, including founding-member benefits.</p>
    </section>
  );
}
